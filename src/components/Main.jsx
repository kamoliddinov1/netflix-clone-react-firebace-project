...
const Main = ({ user }) => {
  return (
    <div>
      ...
      <Films title={"Action movies"} movie_request={sorov.fetchActionMovies} />
      <Films title={"Comedy movies"} movie_request={sorov.fetchComedyMovies} />
      <Films title={"Horror movies"} movie_request={sorov.fetchHorrorMovies} />
      <Films
